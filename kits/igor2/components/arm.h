...
private:
  ...
  alignas(32) Eigen::Vector3d user_commanded_grip_velocity_;
  alignas(32) Eigen::Vector3d grip_position_;
  alignas(32) Eigen::Vector3d new_grip_position_;

  alignas(32) VectorDoF<double> joint_angles_;
  alignas(32) VectorDoF<double> grav_comp_torque_;
  alignas(32) VectorDoF<double> joint_velocities_;
  alignas(32) VectorDoF<double> joint_efforts_;
